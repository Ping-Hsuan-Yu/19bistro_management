  ...
  return (
    <>
      <svg
        ...
        xmlSpace="preserve"
      >
        <g id="d3" className={(tableStatus[19] && "seated ") + (callesStatus[19] && " called")}>
          <path id="D3-3" d="M70.8 689.6H.5v168.7h70.3V689.6z" className="st0"></path>
          <path
            id="D3-2"
            d="M190.3 858.3c19.4 0 35.2 15.7 35.2 35.2s-15.7 35.2-35.2 35.2H35.7C16.3 928.7.5 913 .5 893.5v-35.2h189.8z"
            className="st0"
          ></path>
          <path id="D3-1" d="M225.5 619.2v35.2c0 19.4-15.7 35.2-35.2 35.2H.5v-70.3h225z" className="st0"></path>
          <path id="D3" d="M225.5 703.6H84.9v140.6h140.6V703.6z" className="st1"></path>
          <text id="D3" className="st2 st3" transform="translate(124.203 793.058)">
            D3
          </text>
        </g>
        <g id="d2" className={(tableStatus[18] && "seated ") + (callesStatus[18] && " called")}>
          <path id="D2-3" d="M70.8 380.2H.5v168.7h70.3V380.2z" className="st0"></path>
          <path id="D2-2" d="M190.3 548.9c19.4 0 35.2 15.7 35.2 35.2v35.2H.5V549h189.8z" className="st0"></path>
          <path id="D2-1" d="M225.5 309.9V345c0 19.4-15.7 35.2-35.2 35.2H.5v-70.3h225z" className="st0"></path>
          <path id="D2" d="M225.5 394.2H84.9v140.6h140.6V394.2z" className="st1"></path>
          <text id="D2" className="st2 st3" transform="translate(124.203 483.683)">
            D2
          </text>
        </g>
        <g id="d1" className={(tableStatus[17] && "seated ") + (callesStatus[17] && " called")}>
          <path id="D1-3" d="M70.8 70.8H.5v168.7h70.3V70.8z" className="st0"></path>
          <path id="D1-2" d="M190.3 239.6c19.4 0 35.2 15.7 35.2 35.2V310H.5v-70.3h189.8z" className="st0"></path>
          <path
            id="D1-1"
            d="M190.3.5c19.4 0 35.2 15.7 35.2 35.2s-15.7 35.2-35.2 35.2H.5V35.7C.5 16.3 16.2.5 35.7.5h154.6z"
            className="st0"
          ></path>
          <path id="D1" d="M225.5 84.9H84.9v140.6h140.6V84.9z" className="st1"></path>
          <text id="D1" className="st2 st3" transform="translate(124.203 174.308)">
            D1
          </text>
        </g>
        <g id="c5" className={(tableStatus[16] && "seated ") + (callesStatus[16] && " called")}>
          <path
            id="C5-4"
          ...
          <path
            ...
            className="st1"
          ></path>
          <text id="C5" className="st2 st3" transform="translate(454.88 821.137)">
            C5
          </text>
        </g>
        <g id="c4" className={(tableStatus[15] && "seated ") + (callesStatus[15] && " called")}>
          <path
            id="C4-4"
          ...
          <path
            ...
            className="st1"
          ></path>
          <text id="C4" className="st2 st3" transform="translate(872.212 821.137)">
            C4
          </text>
        </g>
        <g id="c3" className={(tableStatus[14] && "seated ") + (callesStatus[14] && " called")}>
          <path
            id="C3-4"
          ...
          <path
            ...
            className="st1"
          ></path>
          <text id="C3" className="st2 st3" transform="translate(1289.558 821.137)">
            C3
          </text>
        </g>
        <g id="c2" className={(tableStatus[13] && "seated ") + (callesStatus[13] && " called")}>
          <path
            id="C2-4"
          ...
          <path
            ...
            className="st1"
          ></path>
          <text id="C2" className="st2 st3" transform="translate(1080.35 527.23)">
            C2
          </text>
        </g>
        <g id="c1" className={(tableStatus[12] && "seated ") + (callesStatus[12] && " called")}>
          <path
            id="C1-4"
          ...
          <path
            ...
            className="st1"
          ></path>
          <text id="C1" className="st2 st3" transform="translate(663.005 527.23)">
            C1
          </text>
        </g>
        <g id="b8" className={(tableStatus[11] && "seated ") + (callesStatus[11] && " called")}>
          <path
            id="B8s"
            d="M1791.7 894.3c-5.5 5.5-14.4 5.5-19.9 0l-29.8-29.8c-5.5-5.5-5.5-14.4 0-19.9l39.8-39.8 49.7 49.7-39.8 39.8z"
            className="st0"
          ></path>
          <path id="B8" d="M1851.3 695.4l-79.6 79.6 89.5 89.5 79.6-79.5-89.5-89.6z" className="st1"></path>
          <text id="B8" className="st2 st3" transform="translate(1826.933 791.028)">
            B8
          </text>
        </g>
        <g id="b7" className={(tableStatus[10] && "seated ") + (callesStatus[10] && " called")}>
          <path
            id="B7s"
            d="M1702.2 804.8c-5.5 5.5-14.4 5.5-19.9 0l-29.8-29.8c-5.5-5.5-5.5-14.4 0-19.9l39.8-39.8L1742 765l-39.8 39.8z"
            className="st0"
          ></path>
          <path id="B7" d="M1761.8 605.9l-79.6 79.5 89.5 89.5 79.6-79.5-89.5-89.5z" className="st1"></path>
          <text id="B7" className="st2 st3" transform="translate(1737.453 701.534)">
            B7
          </text>
        </g>
        <g id="b6" className={(tableStatus[9] && "seated ") + (callesStatus[9] && " called")}>
          <path
            id="B6s"
            d="M1612.7 715.3c-5.5 5.5-14.4 5.5-19.9 0l-29.8-29.8c-5.5-5.5-5.5-14.4 0-19.9l39.8-39.8 49.7 49.7-39.8 39.8z"
            className="st0"
          ></path>
          <path id="B6" d="M1672.3 516.4l-79.6 79.5 89.5 89.5 79.6-79.5-89.5-89.5z" className="st1"></path>
          <text id="B6" className="st2 st3" transform="translate(1647.959 612.056)">
            B6
          </text>
        </g>
        <g id="b5" className={(tableStatus[8] && "seated ") + (callesStatus[8] && " called")}>
          <path
            id="B5s"
            d="M1523.2 625.8c-5.5 5.5-14.4 5.5-19.9 0l-29.8-29.8c-5.5-5.5-5.5-14.4 0-19.9l39.8-39.8L1563 586l-39.8 39.8z"
            className="st0"
          ></path>
          <path id="B5" d="M1592.8 595.9l-89-89.2 112.5-46.4 56.1 56.1-79.6 79.5z" className="st1"></path>
          <text id="B5" className="st2 st3" transform="translate(1558.711 539.266)">
            B5
          </text>
        </g>
        <g id="b4" className={(tableStatus[7] && "seated ") + (callesStatus[7] && " called")}>
          <path
            id="B4s"
            d="M1433.5 478.6c-7.8 0-14.1-6.3-14.1-14.1v-42.2c0-7.8 6.3-14.1 14.1-14.1h56.2v70.3h-56.2z"
            className="st0"
          ></path>
          <path id="B4" d="M1503.8 506.7V380.2h112.5v80.2l-112.5 46.3z" className="st1"></path>
          <text id="B4" className="st2 st3" transform="translate(1530.685 454.59)">
            B4
          </text>
        </g>
        <g id="b3" className={(tableStatus[6] && "seated ") + (callesStatus[6] && " called")}>
          <path
            id="B3s"
            d="M1433.5 352.1c-7.8 0-14.1-6.3-14.1-14.1v-42.2c0-7.8 6.3-14.1 14.1-14.1h56.2V352h-56.2z"
            className="st0"
          ></path>
          <path id="B3" d="M1616.3 253.6h-112.5v126.6h112.5V253.6z" className="st1"></path>
          <text id="B3" className="st2 st3" transform="translate(1530.685 328.027)">
            B3
          </text>
        </g>
        <g id="b2" className={(tableStatus[5] && "seated ") + (callesStatus[5] && " called")}>
          <path
            id="B2s"
            d="M1433.5 225.5c-7.8 0-14.1-6.3-14.1-14.1v-42.2c0-7.8 6.3-14.1 14.1-14.1h56.2v70.3h-56.2z"
            className="st0"
          ></path>
          <path id="B2" d="M1616.3 127.1h-112.5v126.6h112.5V127.1z" className="st1"></path>
          <text id="B2" className="st2 st3" transform="translate(1530.685 201.464)">
            B2
          </text>
        </g>
        <g id="b1" className={(tableStatus[4] && "seated ") + (callesStatus[4] && " called")}>
          <path
            id="B1s"
            d="M1433.5 98.9c-7.8 0-14.1-6.3-14.1-14.1V42.7c0-7.8 6.3-14.1 14.1-14.1h56.2v70.3h-56.2z"
            className="st0"
          ></path>
          <path id="B1" d="M1616.3.5h-112.5v126.6h112.5V.5z" className="st1"></path>
          <text id="B1" className="st2 st3" transform="translate(1530.685 76.902)">
            B1
          </text>
        </g>
        <g id="a4" className={(tableStatus[3] && "seated ") + (callesStatus[3] && " called")}>
          <path
            id="A4-3"
          ...
          <path
            ...
            className="st0"
          ></path>
          <path id="A4-1" d="M1181.7.5H1013v70.3h168.7V.5z" className="st0"></path>
          <path id="A4" d="M1167.7 84.9h-98.4v98.4h98.4V84.9z" className="st1"></path>
          <text id="A4" className="st2 st3" transform="translate(1088.69 148.215)">
            A4
          </text>
        </g>
        <g id="a3" className={(tableStatus[2] && "seated ") + (callesStatus[2] && " called")}>
          <path
            id="A3-2"
            d="M970.8 253.6c0 7.8-6.3 14.1-14.1 14.1h-42.2c-7.8 0-14.1-6.3-14.1-14.1v-56.2h70.3v56.2z"
            className="st0"
          ></path>
          <path id="A3-1" d="M1013 .5H844.2v70.3H1013V.5z" className="st0"></path>
          <path id="A3" d="M984.9 84.9h-98.4v98.4h98.4V84.9z" className="st1"></path>
          <text id="A3" className="st2 st3" transform="translate(905.877 148.215)">
            A3
          </text>
        </g>
        <g id="a2" className={(tableStatus[1] && "seated ") + (callesStatus[1] && " called")}>
          <path
            id="A2-2"
            d="M788 253.6c0 7.8-6.3 14.1-14.1 14.1h-42.2c-7.8 0-14.1-6.3-14.1-14.1v-56.2H788v56.2z"
            className="st0"
          ></path>
          <path id="A2-1" d="M844.2.5H675.5v70.3h168.7V.5z" className="st0"></path>
          <path id="A2" d="M802.1 84.9h-98.4v98.4h98.4V84.9z" className="st1"></path>
          <text id="A2" className="st2 st3" transform="translate(723.065 148.215)">
            A2
          </text>
        </g>
        <g id="a1" className={(tableStatus[0] && "seated ") + (callesStatus[0] && " called")}>
          <path
            id="A1-3"
          ...
          <path
            ...
            className="st0"
          ></path>
          <path id="A1-1" d="M675.5.5H506.7v70.3h168.7V.5z" className="st0"></path>
          <path id="A1" d="M619.2 84.9h-98.4v98.4h98.4V84.9z" className="st1"></path>
          <text id="A1" className="st2 st3" transform="translate(540.253 148.215)">
            A1
          </text>
        </g>
      </svg>
